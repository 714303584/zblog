	...
	<div id="div_table_main" class="panel panel-default"
		...
		<div id="div_table_heading" class="panel-heading"
			...
			<ol class="breadcrumb" style="margin: 0px">
				<li><a href="list.html">权限管理</a></li>
				<li><a href="add.html">权限添加</a></li>
			</ol>
		</div>
			...
			<div id="tab_body" class="tab-content" style="width: 100%">
				<div class="tab-pane active" id="div_info"
					...
					<form id="commentForm" class="form-horizontal" role="form"
						method="post" action="/admin/permission/edit.html">
						
						<div class="form-group" style="width: 100%;display: none;">
							<label for="inputEmail3" class="col-sm-2 control-label">名称：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="id" name="id"
									style="width: 200px" value="${p.id}">
							</div>
						</div>
						...
						<div class="form-group" style="width: 100%">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name"
									style="width: 200px" value="${p.name }" required>
							</div>
						</div>
						...
						<div id="parent_div" class="form-group" style="width: 100%">
							...
							<div class="col-sm-10">
								<select id="parent" name="parentId" class="form-control"
									style="width: 200px">
						...
						<div class="form-group" style="width: 100%; display: none;">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="parentname"
									name="pname" style="width: 200px" value="${p.pname }">
							</div>
						</div>
						...
						<div class="form-group" style="width: 100%;">
							...
							<div class="col-sm-10">
								<textarea rows="5" style="width: 100%" name="description" >${p.description}</textarea>
							</div>
						</div>
