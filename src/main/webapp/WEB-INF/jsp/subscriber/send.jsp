			...
			<div id="tab_body" class="tab-content" style="width: 100%">
				<div class="tab-pane active" id="div_info"
					...
					<form id="commentForm" class="form-horizontal" role="form"
						method="post" action="/admin/subscriber/send.html">
						<!-- 
						...
						<div class="form-group" style="width: 100%">
							<label for="inputEmail3" class="col-sm-2 control-label">接收邮箱：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="sender" name="recipients"
									style="width: 200px" value="${subscriber.email}" readonly="readonly" required>
							</div>
						</div>
						...
						<div class="form-group" style="width: 100%">
							<label for="inputPassword3" class="col-sm-2 control-label">邮件正文：</label>
							<div class="col-sm-10">
