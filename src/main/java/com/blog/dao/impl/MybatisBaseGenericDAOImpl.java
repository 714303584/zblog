...
import com.blog.dao.IBaseGenericDAO;
import com.blog.dao.util.bean.BeanMapUtil;
import com.blog.dao.util.exception.BaseDaoException;
import com.blog.dao.util.page.GenericDefaultPage;
import com.blog.dao.util.page.IGenericPage;
import com.blog.dao.util.reflect.ReflectGeneric;
/**
 ...
 */
public  class MybatisBaseGenericDAOImpl<T, ID extends Serializable>
extends SqlSessionDaoSupport implements IBaseGenericDAO<T, ID> {
	...
	protected String getDefaultSqlNamespace() {
		Class<T> clazz = null ;
//		= ReflectGeneric.getClassGenricType();
